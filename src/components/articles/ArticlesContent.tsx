...
import {
  ...
  deleteArticle,
  uploadImage,
} from "@/utils/articles-client";
import { useEditor, EditorContent } from "@tiptap/react";
import StarterKit from "@tiptap/starter-kit";
import Placeholder from "@tiptap/extension-placeholder";

const CATEGORIES = ["Цагдаа", "Сэтгэл зүйч", "Эмч", "Сургууль"];
...
export default function ArticlesContent() {
  ...
  const handleDelete = async (id: string) => {
    if (!confirm("Мэдээг устгахдаа итгэлтэй байна уу?")) {
      return;
    }
    ...
    try {
      ...
      setError(
        err instanceof Error ? err.message : "Мэдээг устгах боломжгүй байна"
      );
      console.error(err);
    }
  };
  ...
  return (
    <Box sx={{ width: "100%", maxWidth: 1200, p: 3 }}>
      ...
      {articles.length === 0 ? (
        <Box sx={{ textAlign: "center", py: 8 }}>
          <Typography variant="body1" color="text.secondary">
            Мэдээлэл олдсонгүй. Шинэ мэдээ нэмэхийн тулд мэдээ нэмэх товчийг
            дарна уу.
          </Typography>
        </Box>
      ) : (
      ...
      >
        <DialogTitle>
          {editingArticle ? "Мэдээ засах" : "Мэдээ нэмэх"}
        </DialogTitle>
        <DialogContent>
                ...
                {editor && (
                  ...
                  >
                    ...
                    <IconButton
                      ...
                      color={
                        editor.isActive("blockquote") ? "primary" : "default"
                      }
